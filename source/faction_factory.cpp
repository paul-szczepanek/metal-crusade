...
ulint FactionFactory::uid = 0; //unieque id for each object in the game
...
/** @brief creates a faction and adds it to the list
  ...
  */
Faction* FactionFactory::createFaction(const string& name, global_faction::faction a_faction)
{
...
/** @brief get's the formation based on its name
  ...
  */
Faction* FactionFactory::getFaction(const string& name)
{
...
Ogre::Real FactionFactory::getRelation(Faction* a_from, Faction* a_to)
{
