 ...
 */
template <typename T> void getEnumArray(vector<T>& enum_array,
                                        string     a_buffer)
{
 ...
 */
template <typename T> void getIntArray(vector<T>& int_array,
                                       string     a_buffer)
{
  size_t end = 0;
  string value;
...
void getEnumPairArray(vector<pair<T1, T2> >& position_pair_array,
                      string a_buffer)
{
  vector<string> string_array;
 ...
 */
template <typename T> void getDigitArray(vector<T>& int_array,
                                         string     a_buffer)
{
  for(int i = 0, for_size = a_buffer.size(); i < for_size; ++i) {
